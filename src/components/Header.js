        ...
        return (
            <div className="header">
                ...
                <div className="header_center">
                    <input type="text" name="location" placeholder="Location" onChange={(event) => this.onChangeHandler(event)}></input>
                    <input type="date" name="checkIn" placeholder="Check in" ></input>
                    <input type="date" name="checkOut" placeholder="Check out"></input>
                    <input type="text" name="guests" placeholder="Guests" onChange={(event) => this.onChangeHandler(event)}></input>

                    <Link to={{
                        pathname: "/search-info",
                        state: this.state.houseInfo
                    }}>
                                    ...
                                    {this.state.currentUser === null ?
                                        <div>
                                            <div>
                                                ...
                                                <label id="lbl" className="link"
                                                    onClick={() => {
                                                        console.log('modal closed ');
                                                        close();
                                                    }}>
                                                        <Popup
                                                            trigger={<h3>Sign Up</h3>}
                                                            modal
                                                            nested
                                                        >
                                                            {close => (
                                        ...
                                        <div>
                                            <div>
                                                <Link className="link" ><h3>{this.state.currentUser.username}</h3></Link>
                                            </div>
